    ...
    _snap_on_click: function (e) {
        if (this._markers) {
            ...
            if (this._mouseMarker.snap) {
                ...
                console.info("ssssssssssnnnnnnnnaaaaaaaaaaaaaaaaaaaaaaaaaaaaap");
                L.DomUtil.addClass(marker._icon, "jobsnap"+e.target._latlng.lat+"a"+e.target._latlng.lng);
            }
        }
    },
...
// L.Edit.include(L.Draw.Feature.SnapMixin);
// L.Edit.addInitHook('_snap_initialize');
